...
public class Main {
    public static void main(String[] args) {
        ...
        gryffindor.whoIsTheBest(gryffindors);
        slytherin.whoIsTheBest(slytherins);
        hufflepuff.whoIsTheBest(hufflepuffs);
        ravenclaw.whoIsTheBest(ravenclaws);

        System.out.println(" ");
        System.out.println("Сравнительные оценки между двумя студентами разного факультета");
        hogwarts.whoIsTheBest(gariPotter, dracoMalfoy);
    }
}
